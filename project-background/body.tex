...
Alda is a music programming language intended for live-coding and composing music using only a text editor. It has similar music code syntax to abc, with a goal of being understandable and usable by musicians with no programming experience (https://github.com/alda-lang/alda). Alda supports inline Clojure, a dialect of lisp (clojure.org), giving it rich programming capabilities. It can be exported to MIDI (https://github.com/alda-lang/alda/issues/145), which can in turn be used to generate sheet music using software like MuseScore (https://musescore.org/en/handbook/midi-import). 
